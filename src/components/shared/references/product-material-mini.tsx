...
export default function ProductMaterialMini({
  ...
  return (
    <div className="grid grid-cols-2 gap-2 items-center border rounded-md p-2 bg-muted/40 text-sm">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button type="button" variant="ghost" size="sm" className="h-6 w-6 p-0" onClick={() => handleRemove(id)}>
